...
{
	public class ReadFileExcelItemDto<TDto>
	{
        public TDto Data { get; set; }
        public List<string> InvalidErrors { get; set; }
        public bool IsValid => InvalidErrors?.Any() != true;
    }

    public class ReadFileExcelDto<TDto>
    {
        public List<ReadFileExcelItemDto<TDto>> ValidDtos { get; set; }
        public List<ReadFileExcelItemDto<TDto>> InValidDtos { get; set; }


        public ReadFileExcelDto()
        {
            ValidDtos = new List<ReadFileExcelItemDto<TDto>>();
            InValidDtos = new List<ReadFileExcelItemDto<TDto>>();
        }
    }

    public class ExportExcelCommonDto
    {
